...
public class CollectExample2 {
    private static final Logger log = LoggerFactory.getLogger(CollectExample2.class);

    public static void main(String[] args) {

        // Collect is also useful for accumulating values or state information.
        // Here we will total up the first 12 numbers of the Fibonacci sequence.
        long sum = FibonacciSequence.create(12)
                .collect(
                        // What is the initial state?
                        // In this case we makeObservable a container for an integer.
